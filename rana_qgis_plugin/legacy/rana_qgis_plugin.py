...
from rana_qgis_plugin.legacy.widgets.settings_dialog import SettingsDialog
from rana_qgis_plugin.legacy.widgets.tenant_selection_dialog import (
    TenantSelectionDialog,
)
from rana_qgis_plugin.legacy.widgets.utils_dialog import (
