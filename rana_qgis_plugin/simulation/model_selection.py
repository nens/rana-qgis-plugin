...
uicls, basecls = uic.loadUiType(os.path.join(base_dir, "simulation", "simulation_wizard", "model_selection.ui"))
...
class ModelSelectionDialog(uicls, basecls):
    ...
    def __init__(self, communication, current_user, threedi_api, organisations, working_dir, parent):
        super().__init__(parent)
        self.setupUi(self)
