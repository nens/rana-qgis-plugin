...
class RanaQgisPlugin:
    ...
    def run(self, start_url: str = None):
        ...
        # Go into folder
        index = self.rana_browser.files_browser.files_model.index(4, 0)
        ...
        def run_file_action(file_row: int, file_action, timeout_duration=10000):
            ...
            Args:        file_row (int): The row of the file to process.
        ...
        # vector file
        run_file_action(0, open_in_qgis_action)
        run_file_action(0, self.rana_browser.save_vector_styling_selected)
        # raster file
        run_file_action(2, open_in_qgis_action)
        run_file_action(2, self.rana_browser.save_raster_styling_selected)
